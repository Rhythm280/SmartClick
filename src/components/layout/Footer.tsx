...
import { Camera, Heart, Mail, Phone, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto pt-10 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              A powerful platform for photographers to manage, edit, and securely share their photos with clients.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 flex items-center">
            ...
            <div className="mt-6">
              ...
              <div className="flex mt-1">
                <input
                  ...
                  className="input flex-grow mr-2 h-9"
                />
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            &copy; {currentYear} SmartClick. All rights reserved. Made with <Heart className="inline-block h-4 w-4 text-primary-500" /> for photographers.
          </p>
        </div>
      </div>
    </footer>
